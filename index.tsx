  ...
  return new Promise((resolve) => {
    ...
    reader.onload = (event) => {
      ...
      img.onload = () => {
        ...
        const scaleFactor = 800 / img.width; // Resize to max 800px width
        canvas.width = 800;
...
// ✅ RESTORED ArticleReader COMPONENT
function ArticleReader({ article, allArticles, onBack, onNavigateToArticle, isAdmin }: any) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <button onClick={onBack} className="flex items-center gap-1 text-gray-500 mb-4 text-sm"><ChevronRight className="w-4 h-4 rotate-180"/> Back to News</button>
